...
<div className="w-full">
  <Accordion type="single" collapsible>
    ...
    <AccordionItem value="item-2">
      ...
      <AccordionContent>Yes. It comes with default styles that matches the rest of the components.</AccordionContent>
    </AccordionItem>
    <AccordionItem value="item-3">
      <AccordionTrigger>Is it animated?</AccordionTrigger>
      <AccordionContent>Yes. It includes smooth animations for expanding and collapsing content.</AccordionContent>
    </AccordionItem>
  </Accordion>
</div>
</ComponentPreview>
