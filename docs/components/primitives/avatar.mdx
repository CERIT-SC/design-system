...
<div className="flex flex-wrap gap-6 items-center">
  ...
  <Avatar className="size-12"><AvatarImage src="https://github.com/shadcn.png" alt="Avatar" /><AvatarFallback>JD</AvatarFallback></Avatar>
  <Avatar className="size-16"><AvatarFallback>MR</AvatarFallback></Avatar>
