...
<ComponentPreview>
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 w-full max-w-5xl">
    <Card className="w-full ">
      ...
      <CardContent>
        <P>Default styling with subtle shadow.</P>
      </CardContent>
      <CardFooter>
    ...
    <Card variant="primary" className="w-full">
      ...
      <CardContent>
        <P>Uses primary background color.</P>
      </CardContent>
      <CardFooter>
    ...
    <Card variant="secondary" className="w-full ">
      ...
      <CardContent>
        <P>Uses secondary background color.</P>
      </CardContent>
      <CardFooter>
        <Button>Action</Button>
      </CardFooter>
    ...
    <Card variant="tertiary" className="w-full ">
      ...
      <CardContent>
        <P>Uses tertiary background color.</P>
      </CardContent>
      <CardFooter>
    ...
    <Card variant="gradient" className="w-full ">
      ...
      <CardContent>
        <P>Features a gradient from secondary to tertiary.</P>
      </CardContent>
      <CardFooter>
        <Button variant="default">Action</Button>
      </CardFooter>
    ...
    <Card animation="translate" className="w-full ">
      ...
      <CardContent>
        <P>Hover to see the translate effect.</P>
      </CardContent>
      <CardFooter>
        <Button>Action</Button>
      </CardFooter>
...
<ComponentPreview>
  <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-4 w-full max-w-5xl">
    <Card className="w-full">
      ...
      <CardContent>
        <P>Use CardMedia for images with aspect ratio control.</P>
      </CardContent>
      <CardFooter>
