...
Branding themes override that inherited font — EOSC uses Roboto and eLTER uses Montserrat for headings. Those font files are not bundled with the library; see [Theme Fonts](/docs/foundations/themes) for how to load them in your app.
