                ...
                <ComponentCopySelect
                  components={[
                    ...
                    },
                    {
                      ...
                      import: "import { Lead } from '@e-infra/design-system';",
                    },
                    {
                      name: "Strong",
                    ...
                    },
                    {
                      ...
                      import: "import { Small } from '@e-infra/design-system';",
                    },
                    {
                      name: "Muted",
                      description: "Extra small muted text",
                      import: "import { Muted } from '@e-infra/design-system';",
                    },
                    {
                      name: "Code",
                      description: "Inline code with monospace font",
                      import: "import { Code } from '@e-infra/design-system';",
                    },
                    {
                      name: "Link",
                      description: "Standard link with underline",
                      import: "import { Link } from '@e-infra/design-system';",
                    },
                    {
                      name: "Link",
                      import: "import { Link } from '@e-infra/design-system';",
              ...
              <Panel>
                ...
                <PanelContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Strong>
                      The quick brown fox jumps over the lazy dog. This is
                      emphasized body text for important information that needs
                      to stand out.
                    </Strong>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Small>
                      The quick brown fox jumps over the lazy dog. This is
                      smaller text used for captions, helper text, or secondary
                      information.
                    </Small>
                  </div>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <Alert variant="warning">
                  ...
                  <AlertDescription>
                    Your account will expire in 3 days. Please renew to continue
              ...
              <div className="flex items-center justify-between">
                ...
                <ComponentCopySelect
                  components={[
                    {
                      name: "Input",
                      import: "import { Input } from '@e-infra/design-system';",
                    },
                    {
                      name: "Label",
                      import: "import { Label } from '@e-infra/design-system';",
                    },
                    {
                      name: "Textarea",
                      import:
              ...
              <div className="flex items-center justify-between">
                ...
                <ComponentCopySelect
                  components={[
                    {
                      name: "Badge",
                      import: "import { Badge } from '@e-infra/design-system';",
                    },
                    {
                      name: "Avatar",
                      import:
