  ...
  switch (slug) {
    ...
    case "card":
      return (
        <Card variant={"secondary"} className="max-w-sm">
          ...
          <CardContent>
            <P className={docsTypography.sectionBody}>Card content preview</P>
          </CardContent>
        </Card>
      );
    case "checkbox":
    ...
    case "collapsible":
      return (
        <Collapsible
          defaultOpen
          className="w-full max-w-xl rounded-md border border-border p-3"
        >
    ...
    case "separator":
      return (
        <div className="w-full max-w-md space-y-2">
          <P className="text-sm font-medium text-text-heading">Section A</P>
          <Separator />
          <P className={docsTypography.sectionBody}>Section B</P>
        </div>
      );
    case "skeleton":
      return (
    ...
    case "textarea":
      return (
        <Textarea className="max-w-md" placeholder="Write your feedback..." />
      );
    case "tooltip":
      return (
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <Small className={docsTypography.small}>Tooltip preview</Small>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      );
    ...
    case "feedback-form":
      return (
        <div className="w-full max-w-md space-y-3 rounded-md border border-border bg-background p-4">
          ...
          <Textarea
            rows={3}
            defaultValue="Great component library, thank you!"
          />
...
export function ComponentsOverviewGrid({
  sections,
